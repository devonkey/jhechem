...
public class Utils {
    ...
    public static long getCurrentSecond() {
        return getCurrentMillis() / NumberConst.RATIO_OF_TIME_STAMP;
    }
    ...
    public static boolean isMilliSecond(long tm) {
        return tm > Const.SECOND_MAX;
    }

    public static Long getMilliSecond(Long tm) {
        if (null != tm) {
            return isMilliSecond(tm) ? tm : tm * Const.MILLISECOND_RATIO;
        }
    ...
    public static Long getSecond(Long tm) {
        if (null != tm) {
            return isMilliSecond(tm) ? tm / Const.MILLISECOND_RATIO : tm;
        }
