 ...
 * @since 4.1
 */
public abstract class AbstractJsonMessageConverter extends AbstractHttpMessageConverter<Object>
	...
	protected AbstractJsonMessageConverter(ObjectMapper objectMapper) {
		this.objectMapper = objectMapper;
	}

	protected AbstractJsonMessageConverter(ObjectMapper objectMapper, MediaType supportedMediaType) {
		super(supportedMediaType);
		this.objectMapper = objectMapper;
	}

	protected AbstractJsonMessageConverter(ObjectMapper objectMapper, MediaType... supportedMediaTypes) {
