...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='管理员与角色关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 10004
  DEFAULT CHARSET = utf8mb4 COMMENT ='权限组与权限关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 10004
  DEFAULT CHARSET = utf8mb4 COMMENT ='功能权限操作范围';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='目录权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='常用语配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='权限组与角色关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    `cas`         varchar(20)        NOT NULL DEFAULT '' COMMENT 'cas号',
    `name`        varchar(64)         NOT NULL DEFAULT '' COMMENT '名称',
    `url`         varchar(16)         NOT NULL DEFAULT '' COMMENT '图片地址',
    `create_time` datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`),
    UNIQUE KEY `cas_idx` (`cas`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 995465
