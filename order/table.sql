...
`date2` DATETIME DEFAULT NULL COMMENT '订单交货日期', 
`cjsl` INT(10) UNSIGNED DEFAULT NULL COMMENT '成交数量', 
...
`date3` DATETIME DEFAULT NULL COMMENT '收汇日期', 
...
`kucun` INT(10) UNSIGNED DEFAULT NULL COMMENT '库存数量', 
...
`date4` datetime DEFAULT NULL COMMENT '预计收汇日期', 
